...
from video_study.localplay import launch_local_player, play_protocol_url, timestamp_url
...
class LocalPlaybackTests(unittest.TestCase):
    ...
    def test_protocol_resolves_manifest_and_seeks_locally(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch("video_study.localplay.launch_local_player", return_value=True) as launcher:
    ...
    def test_ffplay_receives_requested_timestamp(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch("video_study.localplay.shutil.which", return_value="ffplay.exe"), patch("video_study.localplay.subprocess.Popen") as popen:
