...
class KnowledgePlanStep:
    spec = StepSpec(
        ...
        owner="zhiying.execution.steps.knowledge", tests=("tests/test_knowledge_planning.py",),
...
class VisualJobsStep:
    spec = StepSpec(
        ...
        config_keys=("visual.jobs",), owner="zhiying.execution.steps.knowledge",
...
class VisualEvidenceStep:
    spec = StepSpec(
        ...
        owner="zhiying.execution.steps.knowledge", tests=("tests/test_visual_retrieval.py", "tests/test_vision_providers.py"),
...
class FrameSemanticsStep:
    spec = StepSpec(
        ...
        owner="zhiying.execution.steps.knowledge", tests=("tests/test_visuals.py",),
...
class CourseIRStep:
    spec = StepSpec(
        ...
        config_keys=(), owner="zhiying.execution.steps.knowledge",
...
class KnowledgeUnitsStep:
    spec = StepSpec(
        ...
        capabilities=("offline", "cloud"), degradation_policy="offline",
        owner="zhiying.execution.steps.knowledge", tests=("tests/test_knowledge_organizer.py", "tests/test_cloud_payload.py"),
...
class KnowledgeSelfcheckStep:
    spec = StepSpec(
        ...
        outputs=(KNOWLEDGE_SELFCHECK,), owner="zhiying.execution.steps.knowledge",
...
class DocumentPlanStep:
    spec = StepSpec(
        ...
        outputs=(DOCUMENT_PLAN,), owner="zhiying.execution.steps.knowledge",
    ...
    def execute(self, context, inputs, staging):
        ...
        from ...documents.v3 import build_document_plan
    ...
    def validate(self, _context, outcome):
        from ...documents.v3 import validate_document_plan
...
class ChapterComposeStep:
    spec = StepSpec(
        ...
        owner="zhiying.execution.steps.knowledge", tests=("tests/test_document_v3.py",),
    ...
    def execute(self, context, inputs, staging):
        from ...documents.v3 import compose_chapters
...
class ChapterValidateStep:
    ...
    def execute(self, context, inputs, staging):
        from ...documents.v3 import validate_chapters
...
class ChapterRepairStep:
    ...
    def execute(self, context, inputs, staging):
        from ...documents.v3 import repair_chapters
...
class DocumentCompileStep:
    ...
    def execute(self, context, inputs, staging):
        from ...documents.v3 import compile_document_v3
    ...
    def validate(self, _context, outcome):
        from ...documents.v3 import validate_document_v3
